...
try {
    ...
    // Nạp Model
    require_once $projectRoot . '/server/app/models/addTaskModel.php'; 
    
    // Nạp Controller
    require_once $projectRoot . '/server/app/controllers/addTaskController.php';
    ...
    // Khởi tạo Controller
    $controller = new AddTaskController($connect);
