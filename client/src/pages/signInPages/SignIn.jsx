...
const SignIn = ({ onLoginSuccess, onSwitchToSignUp }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (valid) {
            try {
                ...
                const response = await fetch('http://todo_list_web.test/server/app/controllers/UserControllerSignIn.php', {
                    method: 'POST',
                    body: dataToSend
                });
    ...
    return (
        ...
        <div className="signInPageWrapper animate__animated animate__fadeInDown">
            <div id="form"> {/* Bỏ thẻ containerDark đi vì đã dùng wrapper */}
                
                {/* --- CỘT TRÁI (Giao diện trang trí) --- */}
                <div className="formInterface">
                    ...
                    <div className="pager">
                        <div id="circle1"><div id="subCircle1"></div></div>
                        <div id="circle2"></div>
                        <div id="circle3"></div>
                    </div>
                </div>
                ...
                <form className="formSignUp" onSubmit={handleSubmit}>
                    ...
                    <div className="input-stack">
                        ...
                        <div className="input-password">
                            ...
                            {errors.general && <div className="input-error">{errors.general}</div>}
                        </div>
                    </div>

                    {/* GENDER INPUT */}
                    <div className="gende-groupAndError">
                        <div id="gender-group" className={shaking.gender ? 'shakeError' : ''}>
                        ...
                        <div className="containerLoginAndGG-GitHub">
                            ...
                            <div className="button-GoogleAndGitHub">
                                <button type="button" id="button-Google">
                                    <img src={googleIcon} alt="G" className="iconGoogle" /> Google
                                </button>
                                <button type="button" id="button-GitHub">
                                    <img src={githubIcon} alt="GH" className="iconGitHub" /> GitHub
                                </button>
                            </div>
                        </div>
                        <div className="registration">
                            <div id="accountYet">Have no account yet?</div>
                            <button type="button" id="button-SignUp" onClick={onSwitchToSignUp}>Registration</button>
                        </div>
                    </div>
                </form>
            </div>
