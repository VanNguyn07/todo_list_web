...
const ForgotPassword = ({ onSwitchToSignIn, onSwitchToVerify }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // 1. Validation
        if (!email) {
            setMessage({ text: "Please enter your email to verification!", type: "error" });
            triggerShake();
            return;
        }
        ...
        try {
            // LƯU Ý: Dùng đường dẫn proxy /api mà chúng ta đã cấu hình
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    // Nếu trang OTP là một component React, bạn nên dùng state ở App.jsx để chuyển
                    // Nếu trang OTP là file php/html riêng thì dùng dòng dưới:
                    onSwitchToVerify();
                }, 1500);
        ...
        <div className="SCOPE_FORGOT_PASS">
            <div className="forgotContainer animate__animated animate__fadeInDown">
                <form onSubmit={handleSubmit} id="forgotForm">
                    ...
                    <p className="desc">Enter your email to receive a verification OTP code!</p>
                    ...
                    <div className="content-forgot-pass">
                        ...
                        <input 
                            ...
                            // Class rung sẽ được thêm vào khi biến isShaking = true
