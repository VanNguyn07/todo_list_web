    ...
    // <div className="SCOPE_TASK_PAGE">
      <div className="app-wrapper">
        ...
        <div className="main-container">
            ...
            <div className="header-top">
              ...
              <div className="plant-widget">
                ...
                <div className="plant-info">
                  <span className="plant-label">Cây đang lớn</span>
          ...
          >
            <Plus size={20} /> Thêm Công Việc Mới
          </button>
                ...
                <div className="card-main">
                  ...
                  <div className="card-actions">
                    ...
                    <button
                      ...
                      title={task.expanded ? "Thu gọn" : "Xem chi tiết"}
                    >
          ...
          <div className="modal-backdrop">
            <div className="modal-container">
              <div className="modal-header">
                <h2>
                  {formState.id ? "✏️ Cập Nhật Task" : "✨ Thêm Task Mới"}
                </h2>
