...
const SignUp = ({ onSwitchToSignIn }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (valid) {
            try {
                ...
                const response = await fetch('http://todo_list_web.test/server/app/controllers/UserControllerSignUp.php', {
                    method: 'POST',
                    body: dataToSend
                });
    ...
    return (
        // Wrapper để căn giữa (Fix lỗi CSS body)
        <div className="signUpPageWrapper animate__animated animate__fadeInDown">
            <div className="containerDark"> 
                <h1>Simple Sign Up Screen</h1>
                    ...
                    <div className="formInterface">
                        <div className="specLogoNew">
                            <div className="imgSpec">
                                <img src="https://tb-static.uber.com/prod/image-proc/processed_images/c5a0d37ae7b51be22093ec988638feb0/3ac2b39ad528f8c8c5dc77c59abb683d.jpeg" alt="Logo"
                                    className="logo" />
                            </div>
                            <div className="title">
                                <div id="spec"><p>SPEC'S</p></div>
                                <div id="projector"><p>PROJECTOR</p></div>
                            </div>
                        </div>
                        ...
                        <div id="text">
                            <p>Welcome aboard my friend<br /><span id="subText">just a couple of clicks and we start</span></p>
                        </div>
                        <div className="pager">
                            <div id="circle1">
                    ...
                    <div className="formSignUp">
                        ...
                        <div className="input-stack">
                            ...
                            <div className="input-UserName">
                                <input 
                                    type="text" name="inputUserName" placeholder="User Name"
                                    value={formData.inputUserName} onChange={handleChange}
                                    className={shaking.inputUserName ? 'shakeError' : ''}
                                />
                                <i className="fa-solid fa-user"></i>
                                {errors.inputUserName && <div className="input-error">{errors.inputUserName}</div>}
                            </div>
                            ...
                            <div className="input-email">
                                <input 
                                    ...
                                    value={formData.inputEmail} onChange={handleChange}
                                    className={shaking.inputEmail ? 'shakeError' : ''}
                                />
                                <i className="fa-solid fa-envelope"></i>
                                {errors.inputEmail && <div className="input-error">{errors.inputEmail}</div>}
                            </div>
                            ...
                            <div className="input-password">
                                <input 
                                    ...
                                    value={formData.inputPassword} onChange={handleChange}
                                    className={shaking.inputPassword ? 'shakeError' : ''}
                                />
                                <i className="fa-solid fa-lock"></i>
                                {errors.inputPassword && <div className="input-error">{errors.inputPassword}</div>}
                            </div>
                        ...
                        {errors.gender && <div className="input-error gender-error">{errors.gender}</div>}


                        <div className="button-create">
                            <button type="submit" id="buttonCreate">Create Account
                        ...
                        <div className="registration">
                            <div id="accountYet" style={{cursor: 'pointer'}} onClick={onSwitchToSignIn}>
                                <a>Already have an account? Sign In</a>
                            </div>
                        </div>

                        {/* Hiển thị lỗi từ Server */}
                        {errors.server && <div className="input-error server-error">{errors.server}</div>}
                    </div>
                </form>
            </div>
        </div>
